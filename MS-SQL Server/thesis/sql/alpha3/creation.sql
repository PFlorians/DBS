...
alter table attendance.summary_public_holidays add constraint
	FK_recId_atrec foreign key(record_id) references attendance.attendance_record(record_id);
alter table attendance.summary_public_holidays add constraint
...
alter table attendance.summary_bonuses add constraint
	FK_summaryID_attrec foreign key (record_id) references attendance.attendance_record(record_id);
go
...
alter table attendance.summary_absence add constraint
	FK_summaryId_attrecab foreign key(record_id) references attendance.attendance_record(record_id);
go
 -- end of FK alterations
-- other alterations
...
values('pflorian', 1, '88000818', 'Patrik', 'Florians', 'Patrik.Florians@heidelbergcement.com');
